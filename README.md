...
```
* * * * * ubuntu bash /home/ubuntu/apps/linklater/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|linklater|tweet|`location`||||
|linklater|facebook|`location`||||
|linklater|email|`location`||||
|linklater|new-comment||||
|linklater|open-share-discuss||||
|linklater|close-share-discuss||||
|linklater|summary-copied||||
|linklater|featured-tweet-action|`action`||``tweet_url``|
|linklater|featured-facebook-action|`action`||``post_url``|
